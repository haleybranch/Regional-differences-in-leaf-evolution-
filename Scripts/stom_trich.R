...
#all<-read.csv("Data/all_stom_trich_mar30.csv")
...
#grab the coefficents 
dm <- summary(mod1)
trichbe_aov <- Anova(mod1, type=3) # treatment < 0.001, treatment*region < 0.001
...
#grab the coefficents 
dm <- summary(mod3)
trich_above_aov <- Anova(mod3, type=3) # treatment < 0.001, treatment*region = 0.08
